...
3. Спільними зусиллями (координує менеджер програми) команда створює **чернетку календарного плану**, шляхом додавання *[Issues](/issues)* для їх перегляду в [GanntLab](https://app.ganttlab.com/).
